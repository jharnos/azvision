...
class CNCVisionApp:
    def __init__(self, master):
        ...
        tk.Label(master, text="Select Resolution:").pack(pady=5)
        resolutions = ["640x480", "1280x720", "1920x1080", "2560x1440"]
        self.resolution_menu = tk.OptionMenu(master, self.selected_resolution, *resolutions, command=self.change_resolution)
